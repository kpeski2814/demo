    ...
    <h2> Nutrición Corporativa</h2>
  	...
  	<div class="bgWhite padding20">
        <div class="col-md-12">
		 ...
		 <div class="col-md-9">
            <div class="subTituloInt">
              <h2>TALLERES NUTRICIONALES PARA EMPRESAS</h2>
            </div>
			<h5>TALLER PARA TRABAJADORES - NUTRIWORKERS</h5>

			<p>Taller dirigido a los trabajadores de su empresa  con el objetivo de mejorar su salud con una buena alimentación lo cual evitará el ausentismo por enfermedad como también mejorará la productividad de su empresa.</p>
			Temario:
			<ul>
				<li>Alimentación Balanceada</li>
				<li>Como prevenir el sobrepeso</li>
				<li>Evitemos las enfermedades con una buena alimentación</li>
				<li>Como estar siempre activo con una adecuada alimentación</li>
			</ul>
			
         <div class="clearfix">&nbsp;</div>			
			
			<h5>TALLER PARA PERSONAL ALIMENTOS-NUTRIHIGIENE</h5>

			<p>Taller dirigido al personal encargado de manipular  alimentos (cocineros, meseros, chef y obreros de fabrica de alimentos)  con el  objetivo de capacitarlos para evitar la contaminación de los alimentos  con  lo cual puede generar disminuir  pérdidas  económicas y  aumentar  su prestigio.</p>
			Temario:
			<ul>
				<li>Higiene y manipulación de alimentos</li>
				<li>Conservación de alimentos</li>
				<li>Control de calidad de Alimentos</li>
			</ul>
