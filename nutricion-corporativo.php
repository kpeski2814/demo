...
<?php include "includes/menu.inc.php"; ?> 
  ...
  <div class="row">
  	<div class="bgWhite padding20">
        <img src="images/fnd-imagen-top-interna.jpg" alt="Nosotras" class="img-responsive"/>
        <div class="clearfix">&nbsp;</div>
  	...
  	<div class="bgWhite padding20">
        ...
        <a href="#" class="btn3"><i class="fa fa-fw fa-envelope"></i>Colegios</a></div>
        </div>
        <div class="col-md-4">
        <div class="btn3-container btn3-left">
        <a href="#" class="btn3"><i class="fa fa-fw fa-envelope"></i>Clubes deportivos</a></div>
        </div>
        <div class="col-md-4">
        <div class="btn3-container btn3-left">
        <a href="#" class="btn3"><i class="fa fa-fw fa-envelope"></i>Empresas</a></div>
        </div>
